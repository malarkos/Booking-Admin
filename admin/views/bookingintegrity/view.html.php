 ...
 * @since  0.0.1
 */
class BookingAdminViewBookingIntegrity extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		BookingAdminHelper::addSubmenu("bookingintegrity");
	...
	{
		JToolBarHelper::title(JText::_('COM_BOOKINGADMIN_MANAGER_BOOKINGINTEGRITY'));
