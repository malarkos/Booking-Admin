 ...
 * @since  0.0.1
 */
class BookingAdminViewPresWeekend extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		BookingAdminHelper::addSubmenu("presweekend");
	...
	{
		JToolBarHelper::title(JText::_('COM_BOOKINGADMIN_MANAGER_PRESWEEKEND'));
