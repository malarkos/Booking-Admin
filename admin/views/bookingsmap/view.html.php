 ...
 * @since  0.0.1
 */
class BookingAdminViewBookingsMap extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		BookingAdminHelper::addSubmenu("bookingsmap");
	...
	{
		JToolBarHelper::title(JText::_('COM_BOOKINGADMIN_MANAGER_BOOKINGSMAP'));
