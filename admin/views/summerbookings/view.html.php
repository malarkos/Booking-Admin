 ...
 * @since  0.0.1
 */
class BookingAdminViewSummerBookings extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		BookingAdminHelper::addSubmenu("summerbookings");
	...
	{
		JToolBarHelper::title(JText::_('COM_BOOKINGADMIN_MANAGER_SUMMERBOOKINGADMIN'));
		JToolBarHelper::addNew('summerbooking.add');
