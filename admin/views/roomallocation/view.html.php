 ...
 * @since  0.0.1
 */
class BookingAdminViewRoomAllocation extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		BookingAdminHelper::addSubmenu("roomallocation");
	...
	{
		JToolBarHelper::title(JText::_('COM_BOOKINGADMIN_MANAGER_ROOMALLOCATION'));
